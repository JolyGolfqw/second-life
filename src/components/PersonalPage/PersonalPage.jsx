              ...
              return (
                <div className={style.card} key={index}>
                  ...
                  <div className={style.cardInfo}>
                    <div className={style.personalName}>{element.name}</div>
                  </div>
                ...
                <div className={style.commentModelRender}>
                  ...
                  <div className={style.commentRenderBody}>
                    <div className={style.commentText}>
                      ...
                      Voluptatem rerum odit ipsam dolore quaerat doloremque
                      minus consectetur, harum, cumque neque nemo odio animi ad
                      illo molestias obcaecati accusamus? Impedit, maxime!
                    </div>
                  </div>
                </div>
              </div>
